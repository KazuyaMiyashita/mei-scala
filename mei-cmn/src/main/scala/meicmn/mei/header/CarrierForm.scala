 ...
 * Module: MEI.header
 */
case class CarrierForm(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.shared.att.Authorized with _root_.meicmn.mei.shared.att.Bibl with _root_.meicmn.mei.shared.att.Lang with _root_.meicmn.mei.header.model.PhysDescPart {
  override def validate(): Boolean = {
    ...
    val elementsValid = Validator.validate(elements, Schemas.schema_carrierForm)
...
object CarrierForm {
  def apply(`analog`: java.lang.String = null, `auth`: java.lang.String = null, `auth.uri`: java.lang.String = null, `class`: java.lang.String = null, `codedval`: java.lang.String = null, `copyof`: java.lang.String = null, `corresp`: java.lang.String = null, `follows`: java.lang.String = null, `label`: java.lang.String = null, `n`: java.lang.String = null, `next`: java.lang.String = null, `precedes`: java.lang.String = null, `prev`: java.lang.String = null, `resp`: java.lang.String = null, `sameas`: java.lang.String = null, `synch`: java.lang.String = null, `translit`: java.lang.String = null, `type`: java.lang.String = null, `xml:base`: java.lang.String = null, `xml:id`: java.lang.String = null, `xml:lang`: java.lang.String = null)(elements: Element*): CarrierForm = {
    ...
    new CarrierForm(elements.toList, attributes)
  }
}
