 ...
 * Module: MEI.header
 */
case class Folium(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.shared.att.Dimensions with _root_.meicmn.mei.shared.att.Measurement with _root_.meicmn.mei.header.att.FoliumSurfaces with _root_.meicmn.mei.header.model.FoliumLike {
