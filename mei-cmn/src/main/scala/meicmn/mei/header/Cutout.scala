 ...
 * Module: MEI.header
 */
case class Cutout(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.shared.att.Dimensions with _root_.meicmn.mei.shared.att.Evidence with _root_.meicmn.mei.shared.att.Measurement with _root_.meicmn.mei.edittrans.att.Trans with _root_.meicmn.mei.shared.att.Xy with _root_.meicmn.mei.header.model.PaperModLike {
