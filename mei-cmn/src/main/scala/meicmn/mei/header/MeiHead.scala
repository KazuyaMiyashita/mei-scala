 ...
 * Module: MEI.header
 */
case class MeiHead(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Basic with _root_.meicmn.mei.shared.att.Bibl with _root_.meicmn.mei.shared.att.Labelled with _root_.meicmn.mei.shared.att.Lang with _root_.meicmn.mei.shared.att.MeiVersion with _root_.meicmn.mei.shared.att.Responsibility {
