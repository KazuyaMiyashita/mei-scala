 ...
 * Module: MEI.header
 */
case class Mensuration(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.shared.att.Bibl with _root_.meicmn.mei.shared.att.Lang with _root_.meicmn.mei.shared.att.mensur.Log with _root_.meicmn.mei.visual.att.mensur.Vis with _root_.meicmn.mei.header.model.WorkIdent {
  override def validate(): Boolean = {
    val allowedAttrs = Set("altsym", "analog", "class", "color", "copyof", "corresp", "dot", "follows", "fontfam", "fontname", "fontsize", "fontstyle", "fontweight", "form", "glyph.auth", "glyph.name", "glyph.num", "glyph.uri", "label", "letterspacing", "level", "lineheight", "loc", "n", "next", "num", "numbase", "orient", "precedes", "prev", "resp", "sameas", "sign", "slash", "synch", "translit", "type", "xml:base", "xml:id", "xml:lang")
...
object Mensuration {
  def apply(`altsym`: java.lang.String = null, `analog`: java.lang.String = null, `class`: java.lang.String = null, `color`: java.lang.String = null, `copyof`: java.lang.String = null, `corresp`: java.lang.String = null, `dot`: java.lang.String = null, `follows`: java.lang.String = null, `fontfam`: java.lang.String = null, `fontname`: java.lang.String = null, `fontsize`: java.lang.String = null, `fontstyle`: java.lang.String = null, `fontweight`: java.lang.String = null, `form`: java.lang.String = null, `glyph.auth`: java.lang.String = null, `glyph.name`: java.lang.String = null, `glyph.num`: java.lang.String = null, `glyph.uri`: java.lang.String = null, `label`: java.lang.String = null, `letterspacing`: java.lang.String = null, `level`: java.lang.String = null, `lineheight`: java.lang.String = null, `loc`: java.lang.String = null, `n`: java.lang.String = null, `next`: java.lang.String = null, `num`: java.lang.String = null, `numbase`: java.lang.String = null, `orient`: java.lang.String = null, `precedes`: java.lang.String = null, `prev`: java.lang.String = null, `resp`: java.lang.String = null, `sameas`: java.lang.String = null, `sign`: java.lang.String = null, `slash`: java.lang.String = null, `synch`: java.lang.String = null, `translit`: java.lang.String = null, `type`: java.lang.String = null, `xml:base`: java.lang.String = null, `xml:id`: java.lang.String = null, `xml:lang`: java.lang.String = null)(elements: Element*): Mensuration = {
