 ...
 * Module: MEI.header
 */
case class Key(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.shared.att.Accidental with _root_.meicmn.mei.shared.att.Bibl with _root_.meicmn.mei.shared.att.KeyMode with _root_.meicmn.mei.shared.att.Pitch with _root_.meicmn.mei.header.model.WorkIdent {
