 ...
 * Module: MEI.header
 */
case class CatRel(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Authorized with _root_.meicmn.mei.shared.att.Basic with _root_.meicmn.mei.shared.att.Bibl with _root_.meicmn.mei.shared.att.Labelled with _root_.meicmn.mei.shared.att.Linking with _root_.meicmn.mei.shared.att.NNumberLike with _root_.meicmn.mei.shared.att.Responsibility {
