 ...
 * Module: MEI.figtable
 */
case class Fig(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.shared.att.HorizontalAlign with _root_.meicmn.mei.shared.att.VerticalAlign with _root_.meicmn.mei.shared.att.Xy with _root_.meicmn.mei.figtable.model.FigureLike {
