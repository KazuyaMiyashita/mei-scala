 ...
 * Module: MEI.cmn
 */
case class Breath(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.cmn.att.breath.Log with _root_.meicmn.mei.visual.att.breath.Vis with _root_.meicmn.mei.gestural.att.breath.Ges with _root_.meicmn.mei.analytical.att.breath.Anl with _root_.meicmn.mei.cmn.model.controleventlike.Cmn {
