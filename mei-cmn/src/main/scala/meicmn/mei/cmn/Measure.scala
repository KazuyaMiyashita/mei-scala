 ...
 * Module: MEI.cmn
 */
case class Measure(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.shared.att.MetadataPointing with _root_.meicmn.mei.shared.att.Pointing with _root_.meicmn.mei.analytical.att.measure.Anl with _root_.meicmn.mei.gestural.att.measure.Ges with _root_.meicmn.mei.cmn.att.measure.Log with _root_.meicmn.mei.visual.att.measure.Vis with _root_.meicmn.mei.shared.att.TargetEval with _root_.meicmn.mei.cmn.model.MeasureLike {
