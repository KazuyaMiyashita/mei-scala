 ...
 * Module: MEI.cmn
 */
case class TupletSpan(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.cmn.att.tupletspan.Log with _root_.meicmn.mei.visual.att.tupletspan.Vis with _root_.meicmn.mei.gestural.att.tupletspan.Ges with _root_.meicmn.mei.analytical.att.tupletspan.Anl with _root_.meicmn.mei.cmn.model.controleventlike.Cmn {
