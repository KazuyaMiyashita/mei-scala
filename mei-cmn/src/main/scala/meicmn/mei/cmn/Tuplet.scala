 ...
 * Module: MEI.cmn
 */
case class Tuplet(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.cmn.att.tuplet.Log with _root_.meicmn.mei.visual.att.tuplet.Vis with _root_.meicmn.mei.gestural.att.tuplet.Ges with _root_.meicmn.mei.analytical.att.tuplet.Anl with _root_.meicmn.mei.cmn.model.eventlike.Cmn {
