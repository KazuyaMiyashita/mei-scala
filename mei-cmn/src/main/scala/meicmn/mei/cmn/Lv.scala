 ...
 * Module: MEI.cmn
 */
case class Lv(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.cmn.att.lv.Log with _root_.meicmn.mei.visual.att.lv.Vis with _root_.meicmn.mei.gestural.att.lv.Ges with _root_.meicmn.mei.analytical.att.lv.Anl with _root_.meicmn.mei.cmn.model.controleventlike.Cmn {
