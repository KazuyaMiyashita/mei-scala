package meicmn.mei.cmn.att.measure
 ...
 * Module: MEI.cmn
 */
trait Log  extends _root_.meicmn.mei.performance.att.Alignment with _root_.meicmn.mei.shared.att.meterconformance.Bar {
