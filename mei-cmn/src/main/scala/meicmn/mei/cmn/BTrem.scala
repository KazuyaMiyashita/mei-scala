 ...
 * Module: MEI.cmn
 */
case class BTrem(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.cmn.att.btrem.Log with _root_.meicmn.mei.visual.att.btrem.Vis with _root_.meicmn.mei.gestural.att.btrem.Ges with _root_.meicmn.mei.analytical.att.btrem.Anl with _root_.meicmn.mei.cmn.model.eventlike.Cmn {
