 ...
 * Module: MEI.cmn
 */
case class FTrem(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.cmn.att.ftrem.Log with _root_.meicmn.mei.visual.att.ftrem.Vis with _root_.meicmn.mei.gestural.att.ftrem.Ges with _root_.meicmn.mei.analytical.att.ftrem.Anl with _root_.meicmn.mei.cmn.model.eventlike.Cmn {
