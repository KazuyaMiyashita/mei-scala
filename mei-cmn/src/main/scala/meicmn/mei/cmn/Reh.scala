 ...
 * Module: MEI.cmn
 */
case class Reh(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.shared.att.Lang with _root_.meicmn.mei.cmn.att.reh.Log with _root_.meicmn.mei.visual.att.reh.Vis with _root_.meicmn.mei.gestural.att.reh.Ges with _root_.meicmn.mei.analytical.att.reh.Anl with _root_.meicmn.mei.cmn.model.controleventlike.Cmn {
