 ...
 * Module: MEI.cmn
 */
case class BracketSpan(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.cmn.att.bracketspan.Log with _root_.meicmn.mei.visual.att.bracketspan.Vis with _root_.meicmn.mei.gestural.att.bracketspan.Ges with _root_.meicmn.mei.analytical.att.bracketspan.Anl with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.cmn.model.controleventlike.Cmn {
