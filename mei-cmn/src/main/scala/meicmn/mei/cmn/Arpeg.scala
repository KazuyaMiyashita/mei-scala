 ...
 * Module: MEI.cmn
 */
case class Arpeg(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.cmn.att.arpeg.Log with _root_.meicmn.mei.visual.att.arpeg.Vis with _root_.meicmn.mei.gestural.att.arpeg.Ges with _root_.meicmn.mei.analytical.att.arpeg.Anl with _root_.meicmn.mei.cmn.model.controleventlike.Cmn {
