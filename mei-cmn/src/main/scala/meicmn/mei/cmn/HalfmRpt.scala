 ...
 * Module: MEI.cmn
 */
case class HalfmRpt(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.cmn.att.halfmrpt.Log with _root_.meicmn.mei.visual.att.halfmrpt.Vis with _root_.meicmn.mei.gestural.att.halfmrpt.Ges with _root_.meicmn.mei.analytical.att.halfmrpt.Anl with _root_.meicmn.mei.cmn.model.eventlike.Cmn {
