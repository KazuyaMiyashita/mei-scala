 ...
 * Module: MEI.cmn
 */
case class Octave(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.cmn.att.octave.Log with _root_.meicmn.mei.visual.att.octave.Vis with _root_.meicmn.mei.gestural.att.octave.Ges with _root_.meicmn.mei.analytical.att.octave.Anl with _root_.meicmn.mei.cmn.model.controleventlike.Cmn {
