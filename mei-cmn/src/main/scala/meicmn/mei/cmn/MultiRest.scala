 ...
 * Module: MEI.cmn
 */
case class MultiRest(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.cmn.att.multirest.Log with _root_.meicmn.mei.visual.att.multirest.Vis with _root_.meicmn.mei.gestural.att.multirest.Ges with _root_.meicmn.mei.analytical.att.multirest.Anl with _root_.meicmn.mei.cmn.model.eventlike.MeasureFilling {
