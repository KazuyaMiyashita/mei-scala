 ...
 * Module: MEI.cmn
 */
case class Tie(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.cmn.att.tie.Log with _root_.meicmn.mei.visual.att.tie.Vis with _root_.meicmn.mei.gestural.att.tie.Ges with _root_.meicmn.mei.analytical.att.tie.Anl with _root_.meicmn.mei.cmn.model.controleventlike.Cmn {
