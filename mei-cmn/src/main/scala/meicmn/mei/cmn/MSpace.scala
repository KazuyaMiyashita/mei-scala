 ...
 * Module: MEI.cmn
 */
case class MSpace(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.cmn.att.mspace.Log with _root_.meicmn.mei.visual.att.mspace.Vis with _root_.meicmn.mei.gestural.att.mspace.Ges with _root_.meicmn.mei.analytical.att.mspace.Anl with _root_.meicmn.mei.cmn.model.eventlike.MeasureFilling {
