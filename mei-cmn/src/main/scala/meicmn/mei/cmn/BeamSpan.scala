 ...
 * Module: MEI.cmn
 */
case class BeamSpan(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.cmn.att.beamspan.Log with _root_.meicmn.mei.visual.att.beamspan.Vis with _root_.meicmn.mei.gestural.att.beamspan.Ges with _root_.meicmn.mei.analytical.att.beamspan.Anl with _root_.meicmn.mei.cmn.model.controleventlike.Cmn {
