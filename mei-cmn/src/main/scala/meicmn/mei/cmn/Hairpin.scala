 ...
 * Module: MEI.cmn
 */
case class Hairpin(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.cmn.att.hairpin.Log with _root_.meicmn.mei.visual.att.hairpin.Vis with _root_.meicmn.mei.gestural.att.hairpin.Ges with _root_.meicmn.mei.analytical.att.hairpin.Anl with _root_.meicmn.mei.cmn.model.controleventlike.Cmn {
