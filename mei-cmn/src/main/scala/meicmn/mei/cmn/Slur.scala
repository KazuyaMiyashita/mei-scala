 ...
 * Module: MEI.cmn
 */
case class Slur(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.cmn.att.slur.Log with _root_.meicmn.mei.visual.att.slur.Vis with _root_.meicmn.mei.gestural.att.slur.Ges with _root_.meicmn.mei.analytical.att.slur.Anl with _root_.meicmn.mei.cmn.model.controleventlike.Cmn {
