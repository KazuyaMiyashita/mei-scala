 ...
 * Module: MEI.harmony
 */
case class ChordMember(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.analytical.att.chordmember.Anl with _root_.meicmn.mei.gestural.att.chordmember.Ges with _root_.meicmn.mei.harmony.att.chordmember.Log with _root_.meicmn.mei.visual.att.chordmember.Vis {
