 ...
 * Module: MEI.harmony
 */
case class ChordDef(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.analytical.att.chorddef.Anl with _root_.meicmn.mei.gestural.att.chorddef.Ges with _root_.meicmn.mei.harmony.att.chorddef.Log with _root_.meicmn.mei.visual.att.chorddef.Vis {
