 ...
 */
case class TabDurSym(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.stringtab.att.Stringtab with _root_.meicmn.mei.stringtab.att.tabdursym.Log with _root_.meicmn.mei.visual.att.tabdursym.Vis with _root_.meicmn.mei.gestural.att.tabdursym.Ges with _root_.meicmn.mei.analytical.att.tabdursym.Anl {
