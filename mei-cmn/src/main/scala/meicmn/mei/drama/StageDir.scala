 ...
 * Module: MEI.drama
 */
case class StageDir(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.shared.att.Lang with _root_.meicmn.mei.analytical.att.stagedir.Anl with _root_.meicmn.mei.gestural.att.stagedir.Ges with _root_.meicmn.mei.drama.att.stagedir.Log with _root_.meicmn.mei.visual.att.stagedir.Vis with _root_.meicmn.mei.drama.model.StageDirLike {
