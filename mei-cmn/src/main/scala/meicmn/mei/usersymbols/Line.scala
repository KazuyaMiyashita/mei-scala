 ...
 */
case class Line(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.analytical.att.line.Anl with _root_.meicmn.mei.gestural.att.line.Ges with _root_.meicmn.mei.usersymbols.att.line.Log with _root_.meicmn.mei.visual.att.line.Vis with _root_.meicmn.mei.usersymbols.model.GraphicPrimitiveLike {
