 ...
 */
case class Curve(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.analytical.att.curve.Anl with _root_.meicmn.mei.gestural.att.curve.Ges with _root_.meicmn.mei.usersymbols.att.curve.Log with _root_.meicmn.mei.visual.att.curve.Vis with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.usersymbols.model.GraphicPrimitiveLike {
