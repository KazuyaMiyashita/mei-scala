 ...
 * Module: MEI.frbr
 */
case class Expression(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.shared.att.Authorized with _root_.meicmn.mei.shared.att.Bibl with _root_.meicmn.mei.shared.att.DataPointing with _root_.meicmn.mei.frbr.model.ExpressionLike {
