 ...
 */
case class Fing(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.analytical.att.fing.Anl with _root_.meicmn.mei.gestural.att.fing.Ges with _root_.meicmn.mei.fingering.att.fing.Log with _root_.meicmn.mei.visual.att.fing.Vis with _root_.meicmn.mei.fingering.model.FingeringLike {
