 ...
 * Module: MEI.shared
 */
case class BarLine(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.shared.att.Pointing with _root_.meicmn.mei.shared.att.TargetEval with _root_.meicmn.mei.analytical.att.barline.Anl with _root_.meicmn.mei.gestural.att.barline.Ges with _root_.meicmn.mei.shared.att.barline.Log with _root_.meicmn.mei.visual.att.barline.Vis with _root_.meicmn.mei.shared.model.EventLike {
