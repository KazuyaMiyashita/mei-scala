 ...
 * Module: MEI.shared
 */
case class Syl(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.shared.att.Lang with _root_.meicmn.mei.analytical.att.syl.Anl with _root_.meicmn.mei.gestural.att.syl.Ges with _root_.meicmn.mei.shared.att.syl.Log with _root_.meicmn.mei.visual.att.syl.Vis with _root_.meicmn.mei.shared.model.SylLike {
