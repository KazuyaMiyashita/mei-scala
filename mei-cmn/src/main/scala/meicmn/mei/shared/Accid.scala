 ...
 * Module: MEI.shared
 */
case class Accid(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.analytical.att.accid.Anl with _root_.meicmn.mei.gestural.att.accid.Ges with _root_.meicmn.mei.shared.att.accid.Log with _root_.meicmn.mei.visual.att.accid.Vis with _root_.meicmn.mei.shared.model.NoteModifierLike {
