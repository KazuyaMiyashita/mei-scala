 ...
 * Module: MEI.shared
 */
case class Dynam(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.shared.att.Lang with _root_.meicmn.mei.analytical.att.dynam.Anl with _root_.meicmn.mei.gestural.att.dynam.Ges with _root_.meicmn.mei.shared.att.dynam.Log with _root_.meicmn.mei.visual.att.dynam.Vis with _root_.meicmn.mei.shared.model.ControlEventLike {
