 ...
 * Module: MEI.shared
 */
case class Tempo(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.shared.att.Bibl with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.shared.att.Lang with _root_.meicmn.mei.analytical.att.tempo.Anl with _root_.meicmn.mei.gestural.att.tempo.Ges with _root_.meicmn.mei.shared.att.tempo.Log with _root_.meicmn.mei.visual.att.tempo.Vis with _root_.meicmn.mei.shared.model.ControlEventLike with _root_.meicmn.mei.header.model.WorkIdent {
