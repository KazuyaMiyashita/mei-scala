 ...
 * Module: MEI.shared
 */
case class Incip(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.shared.att.Bibl with _root_.meicmn.mei.shared.model.IncipLike {
