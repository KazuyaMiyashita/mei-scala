 ...
 * Module: MEI.shared
 */
case class KeySig(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.analytical.att.keysig.Anl with _root_.meicmn.mei.gestural.att.keysig.Ges with _root_.meicmn.mei.shared.att.keysig.Log with _root_.meicmn.mei.visual.att.keysig.Vis with _root_.meicmn.mei.shared.model.KeySigLike {
