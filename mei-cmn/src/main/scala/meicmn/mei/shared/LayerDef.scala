 ...
 * Module: MEI.shared
 */
case class LayerDef(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Basic with _root_.meicmn.mei.shared.att.Labelled with _root_.meicmn.mei.shared.att.Linking with _root_.meicmn.mei.shared.att.MetadataPointing with _root_.meicmn.mei.shared.att.NInteger with _root_.meicmn.mei.shared.att.Responsibility with _root_.meicmn.mei.shared.att.Typed with _root_.meicmn.mei.analytical.att.layerdef.Anl with _root_.meicmn.mei.gestural.att.layerdef.Ges with _root_.meicmn.mei.shared.att.layerdef.Log with _root_.meicmn.mei.visual.att.layerdef.Vis with _root_.meicmn.mei.shared.model.LayerDefLike {
