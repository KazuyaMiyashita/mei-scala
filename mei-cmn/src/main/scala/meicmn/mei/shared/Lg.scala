 ...
 * Module: MEI.shared
 */
case class Lg(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.shared.att.Lang with _root_.meicmn.mei.shared.att.MetadataPointing with _root_.meicmn.mei.shared.att.Xy with _root_.meicmn.mei.analytical.att.lyrics.Anl with _root_.meicmn.mei.gestural.att.lyrics.Ges with _root_.meicmn.mei.lyrics.att.lyrics.Log with _root_.meicmn.mei.visual.att.lyrics.Vis with _root_.meicmn.mei.text.model.LgLike {
