 ...
 * Module: MEI.shared
 */
case class Layer(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Basic with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.shared.att.Labelled with _root_.meicmn.mei.shared.att.Linking with _root_.meicmn.mei.shared.att.MetadataPointing with _root_.meicmn.mei.shared.att.NInteger with _root_.meicmn.mei.shared.att.Responsibility with _root_.meicmn.mei.shared.att.Typed with _root_.meicmn.mei.analytical.att.layer.Anl with _root_.meicmn.mei.gestural.att.layer.Ges with _root_.meicmn.mei.shared.att.layer.Log with _root_.meicmn.mei.visual.att.layer.Vis with _root_.meicmn.mei.shared.model.LayerLike {
