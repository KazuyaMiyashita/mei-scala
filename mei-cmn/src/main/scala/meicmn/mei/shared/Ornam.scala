 ...
 * Module: MEI.shared
 */
case class Ornam(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.analytical.att.ornam.Anl with _root_.meicmn.mei.gestural.att.ornam.Ges with _root_.meicmn.mei.shared.att.ornam.Log with _root_.meicmn.mei.visual.att.ornam.Vis with _root_.meicmn.mei.shared.model.ControlEventLike {
