 ...
 * Module: MEI.shared
 */
case class BiblScope(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.shared.att.Bibl with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.shared.att.Extent with _root_.meicmn.mei.shared.att.Lang with _root_.meicmn.mei.shared.model.BiblPart {
