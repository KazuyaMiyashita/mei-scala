 ...
 * Module: MEI.shared
 */
case class Chord(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.analytical.att.chord.Anl with _root_.meicmn.mei.gestural.att.chord.Ges with _root_.meicmn.mei.shared.att.chord.Log with _root_.meicmn.mei.visual.att.chord.Vis with _root_.meicmn.mei.shared.model.EventLike {
  override def validate(): Boolean = {
    val allowedAttrs = Set("altsym", "artic", "artic.ges", "beam", "breaksec", "class", "cluster", "color", "copyof", "corresp", "cue", "dots", "dots.ges", "dur", "dur.ges", "dur.metrical", "dur.ppq", "dur.real", "dur.recip", "enclose", "facs", "fermata", "follows", "fontfam", "fontname", "fontsize", "fontstyle", "fontweight", "glyph.auth", "glyph.name", "glyph.num", "glyph.uri", "grace", "grace.time", "ho", "instr", "label", "layer", "letterspacing", "lineheight", "lv", "n", "next", "ornam", "precedes", "prev", "resp", "sameas", "slur", "staff", "stem.dir", "stem.len", "stem.mod", "stem.pos", "stem.sameas", "stem.visible", "stem.with", "stem.x", "stem.y", "syl", "synch", "tie", "to", "tstamp", "tstamp.ges", "tstamp.real", "tuplet", "type", "visible", "when", "x", "xml:base", "xml:id", "y")
