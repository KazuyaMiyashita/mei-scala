 ...
 * Module: MEI.shared
 */
case class Phrase(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.analytical.att.phrase.Anl with _root_.meicmn.mei.gestural.att.phrase.Ges with _root_.meicmn.mei.shared.att.phrase.Log with _root_.meicmn.mei.visual.att.phrase.Vis with _root_.meicmn.mei.shared.model.ControlEventLike {
  override def validate(): Boolean = {
    val allowedAttrs = Set("bezier", "bulge", "class", "color", "copyof", "corresp", "curvedir", "dots.ges", "dur", "dur.ges", "dur.metrical", "dur.ppq", "dur.real", "dur.recip", "endho", "endid", "endto", "endvo", "evaluate", "facs", "follows", "ho", "join", "label", "layer", "lform", "lsegs", "lwidth", "n", "next", "part", "partstaff", "plist", "precedes", "prev", "resp", "sameas", "staff", "startho", "startid", "startto", "startvo", "synch", "to", "tstamp", "tstamp.ges", "tstamp.real", "tstamp2", "tstamp2.ges", "tstamp2.real", "type", "vo", "when", "x", "x2", "xml:base", "xml:id", "y", "y2")
    val attributesValid = attributes.keys.forall(allowedAttrs.contains)
    val elementsValid = Validator.validate(elements, Schemas.schema_phrase)
...
object Phrase {
  def apply(`bezier`: java.lang.String = null, `bulge`: java.lang.String = null, `class`: java.lang.String = null, `color`: java.lang.String = null, `copyof`: java.lang.String = null, `corresp`: java.lang.String = null, `curvedir`: java.lang.String = null, `dots.ges`: java.lang.String = null, `dur`: java.lang.String = null, `dur.ges`: java.lang.String = null, `dur.metrical`: java.lang.String = null, `dur.ppq`: java.lang.String = null, `dur.real`: java.lang.String = null, `dur.recip`: java.lang.String = null, `endho`: java.lang.String = null, `endid`: java.lang.String = null, `endto`: java.lang.String = null, `endvo`: java.lang.String = null, `evaluate`: java.lang.String = null, `facs`: java.lang.String = null, `follows`: java.lang.String = null, `ho`: java.lang.String = null, `join`: java.lang.String = null, `label`: java.lang.String = null, `layer`: java.lang.String = null, `lform`: java.lang.String = null, `lsegs`: java.lang.String = null, `lwidth`: java.lang.String = null, `n`: java.lang.String = null, `next`: java.lang.String = null, `part`: java.lang.String = null, `partstaff`: java.lang.String = null, `plist`: java.lang.String = null, `precedes`: java.lang.String = null, `prev`: java.lang.String = null, `resp`: java.lang.String = null, `sameas`: java.lang.String = null, `staff`: java.lang.String = null, `startho`: java.lang.String = null, `startid`: java.lang.String = null, `startto`: java.lang.String = null, `startvo`: java.lang.String = null, `synch`: java.lang.String = null, `to`: java.lang.String = null, `tstamp`: java.lang.String = null, `tstamp.ges`: java.lang.String = null, `tstamp.real`: java.lang.String = null, `tstamp2`: java.lang.String = null, `tstamp2.ges`: java.lang.String = null, `tstamp2.real`: java.lang.String = null, `type`: java.lang.String = null, `vo`: java.lang.String = null, `when`: java.lang.String = null, `x`: java.lang.String = null, `x2`: java.lang.String = null, `xml:base`: java.lang.String = null, `xml:id`: java.lang.String = null, `y`: java.lang.String = null, `y2`: java.lang.String = null)(elements: Element*): Phrase = {
    ...
    new Phrase(elements.toList, attributes)
  }
}
