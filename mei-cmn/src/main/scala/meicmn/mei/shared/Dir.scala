 ...
 * Module: MEI.shared
 */
case class Dir(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.shared.att.Lang with _root_.meicmn.mei.analytical.att.dir.Anl with _root_.meicmn.mei.gestural.att.dir.Ges with _root_.meicmn.mei.shared.att.dir.Log with _root_.meicmn.mei.visual.att.dir.Vis with _root_.meicmn.mei.shared.model.ControlEventLike {
