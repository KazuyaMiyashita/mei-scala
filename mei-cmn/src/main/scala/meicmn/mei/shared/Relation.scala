 ...
 * Module: MEI.shared
 */
case class Relation(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.shared.att.Authorized with _root_.meicmn.mei.shared.att.Bibl with _root_.meicmn.mei.shared.att.Datable with _root_.meicmn.mei.shared.att.Evidence with _root_.meicmn.mei.shared.att.Plist with _root_.meicmn.mei.shared.att.Pointing with _root_.meicmn.mei.shared.att.TargetEval with _root_.meicmn.mei.shared.model.RelationLike {
