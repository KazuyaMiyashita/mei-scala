 ...
 * Module: MEI.shared
 */
case class Ending(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.shared.att.Pointing with _root_.meicmn.mei.shared.att.TargetEval with _root_.meicmn.mei.analytical.att.ending.Anl with _root_.meicmn.mei.gestural.att.ending.Ges with _root_.meicmn.mei.shared.att.ending.Log with _root_.meicmn.mei.visual.att.ending.Vis with _root_.meicmn.mei.shared.model.EndingLike {
