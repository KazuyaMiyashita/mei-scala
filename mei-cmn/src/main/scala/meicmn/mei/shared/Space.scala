 ...
 * Module: MEI.shared
 */
case class Space(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.shared.att.space.Log with _root_.meicmn.mei.visual.att.space.Vis with _root_.meicmn.mei.gestural.att.space.Ges with _root_.meicmn.mei.analytical.att.space.Anl with _root_.meicmn.mei.shared.model.EventLike {
  override def validate(): Boolean = {
    val allowedAttrs = Set("beam", "class", "compressable", "copyof", "corresp", "cutout", "dots", "dots.ges", "dur", "dur.ges", "dur.metrical", "dur.ppq", "dur.real", "dur.recip", "facs", "fermata", "follows", "label", "layer", "n", "next", "precedes", "prev", "resp", "sameas", "staff", "synch", "tstamp", "tstamp.ges", "tstamp.real", "tuplet", "type", "when", "xml:base", "xml:id")
...
object Space {
  def apply(`beam`: java.lang.String = null, `class`: java.lang.String = null, `compressable`: java.lang.String = null, `copyof`: java.lang.String = null, `corresp`: java.lang.String = null, `cutout`: java.lang.String = null, `dots`: java.lang.String = null, `dots.ges`: java.lang.String = null, `dur`: java.lang.String = null, `dur.ges`: java.lang.String = null, `dur.metrical`: java.lang.String = null, `dur.ppq`: java.lang.String = null, `dur.real`: java.lang.String = null, `dur.recip`: java.lang.String = null, `facs`: java.lang.String = null, `fermata`: java.lang.String = null, `follows`: java.lang.String = null, `label`: java.lang.String = null, `layer`: java.lang.String = null, `n`: java.lang.String = null, `next`: java.lang.String = null, `precedes`: java.lang.String = null, `prev`: java.lang.String = null, `resp`: java.lang.String = null, `sameas`: java.lang.String = null, `staff`: java.lang.String = null, `synch`: java.lang.String = null, `tstamp`: java.lang.String = null, `tstamp.ges`: java.lang.String = null, `tstamp.real`: java.lang.String = null, `tuplet`: java.lang.String = null, `type`: java.lang.String = null, `when`: java.lang.String = null, `xml:base`: java.lang.String = null, `xml:id`: java.lang.String = null)(elements: Element*): Space = {
