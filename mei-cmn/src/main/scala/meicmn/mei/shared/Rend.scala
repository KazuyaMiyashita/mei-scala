 ...
 * Module: MEI.shared
 */
case class Rend(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Color with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.externalsymbols.att.extsym.Auth with _root_.meicmn.mei.shared.att.HorizontalAlign with _root_.meicmn.mei.shared.att.Lang with _root_.meicmn.mei.shared.att.TextRendition with _root_.meicmn.mei.shared.att.Typography with _root_.meicmn.mei.shared.att.VerticalAlign with _root_.meicmn.mei.shared.att.Whitespace with _root_.meicmn.mei.shared.model.RendLike {
