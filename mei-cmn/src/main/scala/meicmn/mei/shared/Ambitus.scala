 ...
 * Module: MEI.shared
 */
case class Ambitus(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.analytical.att.ambitus.Anl with _root_.meicmn.mei.gestural.att.ambitus.Ges with _root_.meicmn.mei.shared.att.ambitus.Log with _root_.meicmn.mei.visual.att.ambitus.Vis with _root_.meicmn.mei.shared.att.MetadataPointing {
