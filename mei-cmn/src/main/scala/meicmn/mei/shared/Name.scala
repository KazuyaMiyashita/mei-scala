 ...
 * Module: MEI.shared
 */
case class Name(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Basic with _root_.meicmn.mei.shared.att.Bibl with _root_.meicmn.mei.shared.att.Classed with _root_.meicmn.mei.edittrans.att.Edit with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.shared.att.Labelled with _root_.meicmn.mei.shared.att.Lang with _root_.meicmn.mei.shared.att.Linking with _root_.meicmn.mei.shared.att.Name with _root_.meicmn.mei.shared.att.NNumberLike with _root_.meicmn.mei.shared.att.Responsibility with _root_.meicmn.mei.header.model.EventPart with _root_.meicmn.mei.shared.model.NameLike {
