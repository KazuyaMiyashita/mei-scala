 ...
 * Module: MEI.shared
 */
case class AmbNote(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.analytical.att.ambnote.Anl with _root_.meicmn.mei.gestural.att.ambnote.Ges with _root_.meicmn.mei.shared.att.ambnote.Log with _root_.meicmn.mei.visual.att.ambnote.Vis {
  override def validate(): Boolean = {
    val allowedAttrs = Set("accid", "class", "color", "colored", "copyof", "corresp", "dur", "enclose", "facs", "follows", "fontfam", "fontname", "fontsize", "fontstyle", "fontweight", "head.altsym", "head.auth", "head.color", "head.fill", "head.fillcolor", "head.mod", "head.rotation", "head.shape", "head.visible", "label", "letterspacing", "lineheight", "loc", "n", "next", "oct", "pname", "precedes", "prev", "resp", "sameas", "stem.dir", "stem.len", "stem.mod", "stem.pos", "stem.sameas", "stem.visible", "stem.with", "stem.x", "stem.y", "synch", "type", "xml:base", "xml:id")
