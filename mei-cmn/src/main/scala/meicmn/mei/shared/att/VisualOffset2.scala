 ...
 * Module: MEI.shared
 */
trait VisualOffset2  extends _root_.meicmn.mei.shared.att.visualoffset2.Ho with _root_.meicmn.mei.shared.att.visualoffset2.To with _root_.meicmn.mei.shared.att.visualoffset2.Vo {
