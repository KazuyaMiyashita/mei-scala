 ...
 * Module: MEI.midi
 */
case class Vel(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.midi.att.midi.Event with _root_.meicmn.mei.midi.att.MidiNumber {
