 ...
 * Module: MEI.text
 */
case class Quote(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.shared.att.Lang with _root_.meicmn.mei.shared.att.TextRendition with _root_.meicmn.mei.shared.att.Xy with _root_.meicmn.mei.text.model.QuoteLike {
