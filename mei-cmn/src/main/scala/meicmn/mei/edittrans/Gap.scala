 ...
 */
case class Gap(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.edittrans.att.Edit with _root_.meicmn.mei.shared.att.Extent with _root_.meicmn.mei.shared.att.HandIdent with _root_.meicmn.mei.edittrans.att.ReasonIdent with _root_.meicmn.mei.edittrans.model.TranscriptionLike {
