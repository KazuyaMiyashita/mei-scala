 ...
 */
case class MetaMark(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.shared.att.Lang with _root_.meicmn.mei.edittrans.att.metamark.Log with _root_.meicmn.mei.visual.att.metamark.Vis with _root_.meicmn.mei.gestural.att.metamark.Ges with _root_.meicmn.mei.analytical.att.metamark.Anl with _root_.meicmn.mei.shared.att.Pointing with _root_.meicmn.mei.shared.model.ControlEventLike {
