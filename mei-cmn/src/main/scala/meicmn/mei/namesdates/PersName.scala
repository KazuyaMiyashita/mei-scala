 ...
 */
case class PersName(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meicmn.Element with _root_.meicmn.mei.shared.att.Common with _root_.meicmn.mei.shared.att.Bibl with _root_.meicmn.mei.edittrans.att.Edit with _root_.meicmn.mei.facsimile.att.Facsimile with _root_.meicmn.mei.shared.att.Lang with _root_.meicmn.mei.shared.att.Name with _root_.meicmn.mei.namesdates.model.namelike.Agent {
