 ...
 * Module: MEI.shared
 */
case class PgFoot(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meibasic.Element with _root_.meibasic.mei.shared.att.Common with _root_.meibasic.mei.shared.att.Formework with _root_.meibasic.mei.shared.att.HorizontalAlign with _root_.meibasic.mei.shared.att.Lang {
