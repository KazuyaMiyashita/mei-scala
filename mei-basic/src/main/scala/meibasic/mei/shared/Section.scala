 ...
 * Module: MEI.shared
 */
case class Section(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meibasic.Element with _root_.meibasic.mei.shared.att.Common with _root_.meibasic.mei.gestural.att.section.Ges with _root_.meibasic.mei.shared.att.section.Log with _root_.meibasic.mei.visual.att.section.Vis with _root_.meibasic.mei.shared.model.SectionLike {
