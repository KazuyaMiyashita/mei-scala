 ...
 * Module: MEI.cmn
 */
case class Lv(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meibasic.Element with _root_.meibasic.mei.shared.att.Common with _root_.meibasic.mei.cmn.att.lv.Log with _root_.meibasic.mei.visual.att.lv.Vis with _root_.meibasic.mei.gestural.att.lv.Ges with _root_.meibasic.mei.cmn.model.controleventlike.Cmn {
