 ...
 * Module: MEI.cmn
 */
case class RepeatMark(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meibasic.Element with _root_.meibasic.mei.shared.att.Common with _root_.meibasic.mei.shared.att.Lang with _root_.meibasic.mei.shared.att.repeatmark.Log with _root_.meibasic.mei.visual.att.repeatmark.Vis with _root_.meibasic.mei.gestural.att.repeatmark.Ges with _root_.meibasic.mei.analytical.att.repeatmark.Anl with _root_.meibasic.mei.shared.model.ControlEventLike {
