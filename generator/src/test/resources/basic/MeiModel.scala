...
case class Beam(
    /** <beam> -> model.eventLike.cmn -> bTrem -> <bTrem> (-> BTrem)
      ...
      */
    elements: scala.List[BTrem | Beam | BeatRpt | Chord | Clef | ClefGrp | FTrem | GraceGrp | HalfmRpt | Note | Rest | Space | TabGrp | Tuplet] = scala.Nil,
    /** Regularizes the naming of an element and thus facilitates building links between it and other resources. Each id attribute within a document must have a unique value.
      * 
...
case class Measure(
    /** <measure> -> model.measurePart -> model.controlEventLike.cmn -> arpeg -> <arpeg> (-> Arpeg)
      ...
      */
    elements: scala.List[Arpeg | Breath | Caesura | Dir | Dynam | Fermata | Fing | FingGrp | Gliss | Hairpin | Harm | HarpPedal | Lv | MNum | Mordent | Octave | Ornam | Pb | Pedal | Reh | RepeatMark | Sb | Slur | Staff | Tempo | Tie | Trill | Turn] = scala.Nil,
    /** Regularizes the naming of an element and thus facilitates building links between it and other resources. Each id attribute within a document must have a unique value.
      * 
...
case class Layer(
    /** <layer> -> model.layerPart -> model.layerPart.cmn -> model.eventLike.cmn -> bTrem -> <bTrem> (-> BTrem)
      ...
      */
    elements: scala.List[BTrem | Beam | BeatRpt | Chord | Clef | ClefGrp | FTrem | GraceGrp | HalfmRpt | MRest | MRpt | MultiRest | MultiRpt | Note | Pb | Rest | Sb | Space | TabGrp | Tuplet] = scala.Nil,
    /** Regularizes the naming of an element and thus facilitates building links between it and other resources. Each id attribute within a document must have a unique value.
      * 
