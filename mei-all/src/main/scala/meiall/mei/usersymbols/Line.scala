 ...
 */
case class Line(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.analytical.att.line.Anl with _root_.meiall.mei.gestural.att.line.Ges with _root_.meiall.mei.usersymbols.att.line.Log with _root_.meiall.mei.visual.att.line.Vis with _root_.meiall.mei.usersymbols.model.GraphicPrimitiveLike {
