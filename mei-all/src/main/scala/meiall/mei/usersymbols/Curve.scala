 ...
 */
case class Curve(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.analytical.att.curve.Anl with _root_.meiall.mei.gestural.att.curve.Ges with _root_.meiall.mei.usersymbols.att.curve.Log with _root_.meiall.mei.visual.att.curve.Vis with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.usersymbols.model.GraphicPrimitiveLike {
