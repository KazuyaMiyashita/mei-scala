 ...
 * Module: MEI.shared
 */
case class Chord(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.analytical.att.chord.Anl with _root_.meiall.mei.gestural.att.chord.Ges with _root_.meiall.mei.shared.att.chord.Log with _root_.meiall.mei.visual.att.chord.Vis with _root_.meiall.mei.shared.model.EventLike {
