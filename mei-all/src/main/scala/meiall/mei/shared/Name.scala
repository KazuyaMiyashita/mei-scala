 ...
 * Module: MEI.shared
 */
case class Name(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with meiall.mei.shared.att.Basic with meiall.mei.shared.att.Bibl with meiall.mei.shared.att.Classed with meiall.mei.edittrans.att.Edit with meiall.mei.facsimile.att.Facsimile with meiall.mei.shared.att.Labelled with meiall.mei.shared.att.Lang with meiall.mei.shared.att.Linking with meiall.mei.shared.att.Name with meiall.mei.shared.att.NNumberLike with meiall.mei.shared.att.Responsibility with meiall.mei.header.model.EventPart with meiall.mei.shared.model.NameLike {
