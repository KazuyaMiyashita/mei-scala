 ...
 * Module: MEI.shared
 */
case class Note(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with meiall.mei.shared.att.Common with meiall.mei.facsimile.att.Facsimile with meiall.mei.analytical.att.note.Anl with meiall.mei.gestural.att.note.Ges with meiall.mei.shared.att.note.Log with meiall.mei.visual.att.note.Vis with meiall.mei.shared.model.ChordPart with meiall.mei.shared.model.EventLike {
