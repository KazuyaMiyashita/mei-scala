 ...
 * Module: MEI.shared
 */
case class Layer(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Basic with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.shared.att.Labelled with _root_.meiall.mei.shared.att.Linking with _root_.meiall.mei.shared.att.MetadataPointing with _root_.meiall.mei.shared.att.NInteger with _root_.meiall.mei.shared.att.Responsibility with _root_.meiall.mei.shared.att.Typed with _root_.meiall.mei.analytical.att.layer.Anl with _root_.meiall.mei.gestural.att.layer.Ges with _root_.meiall.mei.shared.att.layer.Log with _root_.meiall.mei.visual.att.layer.Vis with _root_.meiall.mei.shared.model.LayerLike {
