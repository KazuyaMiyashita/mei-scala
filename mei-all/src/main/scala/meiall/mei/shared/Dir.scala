 ...
 * Module: MEI.shared
 */
case class Dir(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with meiall.mei.shared.att.Common with meiall.mei.facsimile.att.Facsimile with meiall.mei.shared.att.Lang with meiall.mei.analytical.att.dir.Anl with meiall.mei.gestural.att.dir.Ges with meiall.mei.shared.att.dir.Log with meiall.mei.visual.att.dir.Vis with meiall.mei.shared.model.ControlEventLike {
