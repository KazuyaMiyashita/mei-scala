 ...
 * Module: MEI.shared
 */
case class Dir(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.shared.att.Lang with _root_.meiall.mei.analytical.att.dir.Anl with _root_.meiall.mei.gestural.att.dir.Ges with _root_.meiall.mei.shared.att.dir.Log with _root_.meiall.mei.visual.att.dir.Vis with _root_.meiall.mei.shared.model.ControlEventLike {
