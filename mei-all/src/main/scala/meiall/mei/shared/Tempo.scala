 ...
 * Module: MEI.shared
 */
case class Tempo(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.shared.att.Bibl with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.shared.att.Lang with _root_.meiall.mei.analytical.att.tempo.Anl with _root_.meiall.mei.gestural.att.tempo.Ges with _root_.meiall.mei.shared.att.tempo.Log with _root_.meiall.mei.visual.att.tempo.Vis with _root_.meiall.mei.shared.model.ControlEventLike with _root_.meiall.mei.header.model.WorkIdent {
