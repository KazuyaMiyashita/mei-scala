 ...
 * Module: MEI.shared
 */
case class Dynam(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with meiall.mei.shared.att.Common with meiall.mei.facsimile.att.Facsimile with meiall.mei.shared.att.Lang with meiall.mei.analytical.att.dynam.Anl with meiall.mei.gestural.att.dynam.Ges with meiall.mei.shared.att.dynam.Log with meiall.mei.visual.att.dynam.Vis with meiall.mei.shared.model.ControlEventLike {
