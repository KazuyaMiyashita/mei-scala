 ...
 * Module: MEI.shared
 */
trait VisualOffset  extends _root_.meiall.mei.shared.att.visualoffset.Ho with _root_.meiall.mei.shared.att.visualoffset.To with _root_.meiall.mei.shared.att.visualoffset.Vo {
