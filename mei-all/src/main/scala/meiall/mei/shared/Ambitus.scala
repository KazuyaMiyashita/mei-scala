 ...
 * Module: MEI.shared
 */
case class Ambitus(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.analytical.att.ambitus.Anl with _root_.meiall.mei.gestural.att.ambitus.Ges with _root_.meiall.mei.shared.att.ambitus.Log with _root_.meiall.mei.visual.att.ambitus.Vis with _root_.meiall.mei.shared.att.MetadataPointing {
