 ...
 * Module: MEI.shared
 */
case class ScoreDef(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.analytical.att.scoredef.Anl with _root_.meiall.mei.gestural.att.scoredef.Ges with _root_.meiall.mei.shared.att.scoredef.Log with _root_.meiall.mei.visual.att.scoredef.Vis with _root_.meiall.mei.shared.model.ScoreDefLike {
