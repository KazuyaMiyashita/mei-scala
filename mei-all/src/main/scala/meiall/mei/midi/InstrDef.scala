 ...
 * Module: MEI.midi
 */
case class InstrDef(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Basic with _root_.meiall.mei.shared.att.Labelled with _root_.meiall.mei.shared.att.Linking with _root_.meiall.mei.shared.att.MetadataPointing with _root_.meiall.mei.shared.att.NInteger with _root_.meiall.mei.shared.att.Responsibility with _root_.meiall.mei.shared.att.Typed with _root_.meiall.mei.analytical.att.instrdef.Anl with _root_.meiall.mei.gestural.att.instrdef.Ges with _root_.meiall.mei.midi.att.instrdef.Log with _root_.meiall.mei.visual.att.instrdef.Vis with _root_.meiall.mei.shared.model.InstrDefLike {
