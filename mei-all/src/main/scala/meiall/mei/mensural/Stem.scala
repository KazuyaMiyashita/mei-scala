...
case class Stem(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with meiall.mei.shared.att.Common with meiall.mei.facsimile.att.Facsimile with meiall.mei.mensural.att.stem.Log with meiall.mei.visual.att.stem.Vis with meiall.mei.gestural.att.stem.Ges with meiall.mei.analytical.att.stem.Anl {
  override def validate(): Boolean = {
    ...
    val elementsValid = Validator.validate(elements, Schemas.schema_stem)
...
object Stem {
  def apply(`class`: java.lang.String = null, `color`: java.lang.String = null, `copyof`: java.lang.String = null, `corresp`: java.lang.String = null, `dir`: java.lang.String = null, `facs`: java.lang.String = null, `flag.form`: java.lang.String = null, `flag.pos`: java.lang.String = null, `follows`: java.lang.String = null, `form`: java.lang.String = null, `glyph.auth`: java.lang.String = null, `glyph.name`: java.lang.String = null, `glyph.num`: java.lang.String = null, `glyph.uri`: java.lang.String = null, `label`: java.lang.String = null, `len`: java.lang.String = null, `n`: java.lang.String = null, `next`: java.lang.String = null, `pos`: java.lang.String = null, `precedes`: java.lang.String = null, `prev`: java.lang.String = null, `resp`: java.lang.String = null, `sameas`: java.lang.String = null, `synch`: java.lang.String = null, `type`: java.lang.String = null, `visible`: java.lang.String = null, `x`: java.lang.String = null, `xml:base`: java.lang.String = null, `xml:id`: java.lang.String = null, `y`: java.lang.String = null)(elements: Element*): Stem = {
    val attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String] = scala.collection.immutable.SeqMap.from(scala.List(
      ...
      if (`flag.form` != null) Some("flag.form" -> `flag.form`) else None,
      if (`flag.pos` != null) Some("flag.pos" -> `flag.pos`) else None,
      ...
      if (`pos` != null) Some("pos" -> `pos`) else None,
    ...
    new Stem(elements.toList, attributes)
  }
}
