...
case class Mensur(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with meiall.mei.shared.att.Common with meiall.mei.facsimile.att.Facsimile with meiall.mei.shared.att.mensur.Log with meiall.mei.visual.att.mensur.Vis with meiall.mei.gestural.att.mensur.Ges with meiall.mei.analytical.att.mensur.Anl with meiall.mei.mensural.model.eventlike.Mensural with meiall.mei.mensural.model.staffdefpart.Mensural {
  override def validate(): Boolean = {
    ...
    val elementsValid = Validator.validate(elements, Schemas.schema_mensur)
...
object Mensur {
  def apply(`altsym`: java.lang.String = null, `class`: java.lang.String = null, `color`: java.lang.String = null, `copyof`: java.lang.String = null, `corresp`: java.lang.String = null, `divisio`: java.lang.String = null, `dot`: java.lang.String = null, `facs`: java.lang.String = null, `follows`: java.lang.String = null, `fontfam`: java.lang.String = null, `fontname`: java.lang.String = null, `fontsize`: java.lang.String = null, `fontstyle`: java.lang.String = null, `fontweight`: java.lang.String = null, `form`: java.lang.String = null, `glyph.auth`: java.lang.String = null, `glyph.name`: java.lang.String = null, `glyph.num`: java.lang.String = null, `glyph.uri`: java.lang.String = null, `label`: java.lang.String = null, `letterspacing`: java.lang.String = null, `level`: java.lang.String = null, `lineheight`: java.lang.String = null, `loc`: java.lang.String = null, `modusmaior`: java.lang.String = null, `modusminor`: java.lang.String = null, `n`: java.lang.String = null, `next`: java.lang.String = null, `num`: java.lang.String = null, `numbase`: java.lang.String = null, `orient`: java.lang.String = null, `precedes`: java.lang.String = null, `prev`: java.lang.String = null, `prolatio`: java.lang.String = null, `resp`: java.lang.String = null, `sameas`: java.lang.String = null, `sign`: java.lang.String = null, `slash`: java.lang.String = null, `synch`: java.lang.String = null, `tempus`: java.lang.String = null, `type`: java.lang.String = null, `xml:base`: java.lang.String = null, `xml:id`: java.lang.String = null)(elements: Element*): Mensur = {
    ...
    new Mensur(elements.toList, attributes)
  }
}
