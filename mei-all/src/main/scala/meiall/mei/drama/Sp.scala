 ...
 * Module: MEI.drama
 */
case class Sp(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with meiall.mei.shared.att.Common with meiall.mei.facsimile.att.Facsimile with meiall.mei.shared.att.Lang with meiall.mei.analytical.att.sp.Anl with meiall.mei.gestural.att.sp.Ges with meiall.mei.drama.att.sp.Log with meiall.mei.visual.att.sp.Vis with meiall.mei.shared.model.ControlEventLike {
