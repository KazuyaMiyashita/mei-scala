 ...
 * Module: MEI.drama
 */
case class Sp(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.shared.att.Lang with _root_.meiall.mei.analytical.att.sp.Anl with _root_.meiall.mei.gestural.att.sp.Ges with _root_.meiall.mei.drama.att.sp.Log with _root_.meiall.mei.visual.att.sp.Vis with _root_.meiall.mei.shared.model.ControlEventLike {
