 ...
 * Module: MEI.visual
 */
trait Vis  extends _root_.meiall.mei.shared.att.Color with _root_.meiall.mei.shared.att.Curvature with _root_.meiall.mei.shared.att.linerend.Base with _root_.meiall.mei.shared.att.VerticalGroup with _root_.meiall.mei.shared.att.VisualOffset with _root_.meiall.mei.shared.att.VisualOffset2 with _root_.meiall.mei.shared.att.Xy with _root_.meiall.mei.shared.att.Xy2 {
