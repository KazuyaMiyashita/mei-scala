 ...
 * Module: MEI.visual
 */
trait Vis  extends meiall.mei.shared.att.Color with meiall.mei.shared.att.linerend.Base with meiall.mei.shared.att.PlacementRelStaff with meiall.mei.shared.att.VerticalGroup with meiall.mei.shared.att.VisualOffset with meiall.mei.shared.att.VisualOffset2 with meiall.mei.shared.att.Xy with meiall.mei.shared.att.Xy2 {
