 ...
 */
case class Trill(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with meiall.mei.shared.att.Common with meiall.mei.facsimile.att.Facsimile with meiall.mei.analytical.att.trill.Anl with meiall.mei.gestural.att.trill.Ges with meiall.mei.cmnornaments.att.trill.Log with meiall.mei.visual.att.trill.Vis with meiall.mei.cmnornaments.model.ornamentlike.Cmn {
