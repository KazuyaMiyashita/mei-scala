 ...
 */
case class Trill(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.analytical.att.trill.Anl with _root_.meiall.mei.gestural.att.trill.Ges with _root_.meiall.mei.cmnornaments.att.trill.Log with _root_.meiall.mei.visual.att.trill.Vis with _root_.meiall.mei.cmnornaments.model.ornamentlike.Cmn {
