 ...
 */
case class MetaMark(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.shared.att.Lang with _root_.meiall.mei.edittrans.att.metamark.Log with _root_.meiall.mei.visual.att.metamark.Vis with _root_.meiall.mei.gestural.att.metamark.Ges with _root_.meiall.mei.analytical.att.metamark.Anl with _root_.meiall.mei.shared.att.Pointing with _root_.meiall.mei.shared.model.ControlEventLike {
