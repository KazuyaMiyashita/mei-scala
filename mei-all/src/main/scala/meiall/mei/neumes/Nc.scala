 ...
 * Module: MEI.neumes
 */
case class Nc(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Basic with _root_.meiall.mei.shared.att.Classed with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.shared.att.Labelled with _root_.meiall.mei.shared.att.Linking with _root_.meiall.mei.shared.att.NNumberLike with _root_.meiall.mei.shared.att.Responsibility with _root_.meiall.mei.analytical.att.nc.Anl with _root_.meiall.mei.gestural.att.nc.Ges with _root_.meiall.mei.neumes.att.nc.Log with _root_.meiall.mei.visual.att.nc.Vis with _root_.meiall.mei.neumes.model.NeumePart {
