 ...
 * Module: MEI.neumes
 */
case class Syllable(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.analytical.att.syllable.Anl with _root_.meiall.mei.gestural.att.syllable.Ges with _root_.meiall.mei.neumes.att.syllable.Log with _root_.meiall.mei.visual.att.syllable.Vis with _root_.meiall.mei.neumes.model.SyllableLike {
