 ...
 * Module: MEI.header
 */
case class Cutout(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.shared.att.Dimensions with _root_.meiall.mei.shared.att.Evidence with _root_.meiall.mei.shared.att.Measurement with _root_.meiall.mei.edittrans.att.Trans with _root_.meiall.mei.shared.att.Xy with _root_.meiall.mei.header.model.PaperModLike {
