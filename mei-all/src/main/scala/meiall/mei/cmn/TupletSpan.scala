 ...
 * Module: MEI.cmn
 */
case class TupletSpan(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.cmn.att.tupletspan.Log with _root_.meiall.mei.visual.att.tupletspan.Vis with _root_.meiall.mei.gestural.att.tupletspan.Ges with _root_.meiall.mei.analytical.att.tupletspan.Anl with _root_.meiall.mei.cmn.model.controleventlike.Cmn {
