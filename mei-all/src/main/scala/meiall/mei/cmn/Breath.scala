 ...
 * Module: MEI.cmn
 */
case class Breath(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.cmn.att.breath.Log with _root_.meiall.mei.visual.att.breath.Vis with _root_.meiall.mei.gestural.att.breath.Ges with _root_.meiall.mei.analytical.att.breath.Anl with _root_.meiall.mei.cmn.model.controleventlike.Cmn {
