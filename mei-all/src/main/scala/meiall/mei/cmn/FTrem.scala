 ...
 * Module: MEI.cmn
 */
case class FTrem(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.cmn.att.ftrem.Log with _root_.meiall.mei.visual.att.ftrem.Vis with _root_.meiall.mei.gestural.att.ftrem.Ges with _root_.meiall.mei.analytical.att.ftrem.Anl with _root_.meiall.mei.cmn.model.eventlike.Cmn {
