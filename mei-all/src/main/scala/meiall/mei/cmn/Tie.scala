 ...
 * Module: MEI.cmn
 */
case class Tie(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.cmn.att.tie.Log with _root_.meiall.mei.visual.att.tie.Vis with _root_.meiall.mei.gestural.att.tie.Ges with _root_.meiall.mei.analytical.att.tie.Anl with _root_.meiall.mei.cmn.model.controleventlike.Cmn {
