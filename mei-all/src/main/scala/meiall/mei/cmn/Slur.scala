 ...
 * Module: MEI.cmn
 */
case class Slur(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with meiall.mei.shared.att.Common with meiall.mei.facsimile.att.Facsimile with meiall.mei.cmn.att.slur.Log with meiall.mei.visual.att.slur.Vis with meiall.mei.gestural.att.slur.Ges with meiall.mei.analytical.att.slur.Anl with meiall.mei.cmn.model.controleventlike.Cmn {
