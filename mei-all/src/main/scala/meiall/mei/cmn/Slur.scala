 ...
 * Module: MEI.cmn
 */
case class Slur(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.cmn.att.slur.Log with _root_.meiall.mei.visual.att.slur.Vis with _root_.meiall.mei.gestural.att.slur.Ges with _root_.meiall.mei.analytical.att.slur.Anl with _root_.meiall.mei.cmn.model.controleventlike.Cmn {
