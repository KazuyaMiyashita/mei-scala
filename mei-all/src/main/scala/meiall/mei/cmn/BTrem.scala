 ...
 * Module: MEI.cmn
 */
case class BTrem(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.cmn.att.btrem.Log with _root_.meiall.mei.visual.att.btrem.Vis with _root_.meiall.mei.gestural.att.btrem.Ges with _root_.meiall.mei.analytical.att.btrem.Anl with _root_.meiall.mei.cmn.model.eventlike.Cmn {
