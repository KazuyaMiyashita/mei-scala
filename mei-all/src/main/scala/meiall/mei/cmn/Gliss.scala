 ...
 * Module: MEI.cmn
 */
case class Gliss(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with meiall.mei.shared.att.Common with meiall.mei.facsimile.att.Facsimile with meiall.mei.cmn.att.gliss.Log with meiall.mei.visual.att.gliss.Vis with meiall.mei.gestural.att.gliss.Ges with meiall.mei.analytical.att.gliss.Anl with meiall.mei.shared.model.ControlEventLike {
