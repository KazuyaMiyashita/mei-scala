 ...
 * Module: MEI.cmn
 */
case class Gliss(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.cmn.att.gliss.Log with _root_.meiall.mei.visual.att.gliss.Vis with _root_.meiall.mei.gestural.att.gliss.Ges with _root_.meiall.mei.analytical.att.gliss.Anl with _root_.meiall.mei.shared.model.ControlEventLike {
