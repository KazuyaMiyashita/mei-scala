 ...
 * Module: MEI.cmn
 */
case class RepeatMark(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with meiall.mei.shared.att.Common with meiall.mei.facsimile.att.Facsimile with meiall.mei.shared.att.Lang with meiall.mei.shared.att.repeatmark.Log with meiall.mei.visual.att.repeatmark.Vis with meiall.mei.gestural.att.repeatmark.Ges with meiall.mei.analytical.att.repeatmark.Anl with meiall.mei.shared.model.ControlEventLike {
