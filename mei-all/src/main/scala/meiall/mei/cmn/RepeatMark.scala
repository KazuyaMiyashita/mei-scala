 ...
 * Module: MEI.cmn
 */
case class RepeatMark(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.shared.att.Lang with _root_.meiall.mei.shared.att.repeatmark.Log with _root_.meiall.mei.visual.att.repeatmark.Vis with _root_.meiall.mei.gestural.att.repeatmark.Ges with _root_.meiall.mei.analytical.att.repeatmark.Anl with _root_.meiall.mei.shared.model.ControlEventLike {
