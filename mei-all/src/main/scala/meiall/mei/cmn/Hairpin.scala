 ...
 * Module: MEI.cmn
 */
case class Hairpin(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.cmn.att.hairpin.Log with _root_.meiall.mei.visual.att.hairpin.Vis with _root_.meiall.mei.gestural.att.hairpin.Ges with _root_.meiall.mei.analytical.att.hairpin.Anl with _root_.meiall.mei.cmn.model.controleventlike.Cmn {
