 ...
 * Module: MEI.cmn
 */
case class BracketSpan(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.cmn.att.bracketspan.Log with _root_.meiall.mei.visual.att.bracketspan.Vis with _root_.meiall.mei.gestural.att.bracketspan.Ges with _root_.meiall.mei.analytical.att.bracketspan.Anl with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.cmn.model.controleventlike.Cmn {
