 ...
 * Module: MEI.cmn
 */
case class Attacca(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with _root_.meiall.mei.shared.att.Common with _root_.meiall.mei.facsimile.att.Facsimile with _root_.meiall.mei.shared.att.Lang with _root_.meiall.mei.analytical.att.attacca.Anl with _root_.meiall.mei.gestural.att.attacca.Ges with _root_.meiall.mei.shared.att.attacca.Log with _root_.meiall.mei.visual.att.attacca.Vis with _root_.meiall.mei.cmn.model.controleventlike.Cmn {
