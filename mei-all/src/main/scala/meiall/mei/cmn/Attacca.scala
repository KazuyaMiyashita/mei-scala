 ...
 * Module: MEI.cmn
 */
case class Attacca(elements: scala.List[Element], attributes: scala.collection.immutable.SeqMap[java.lang.String, java.lang.String])  extends meiall.Element with meiall.mei.shared.att.Common with meiall.mei.facsimile.att.Facsimile with meiall.mei.shared.att.Lang with meiall.mei.analytical.att.attacca.Anl with meiall.mei.gestural.att.attacca.Ges with meiall.mei.shared.att.attacca.Log with meiall.mei.visual.att.attacca.Vis with meiall.mei.cmn.model.controleventlike.Cmn {
